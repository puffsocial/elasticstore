...
class Config {
  public FB_PROJECT_ID: string = process.env.FB_PROJECT_ID
  ...
  public FB_USE_ADC: boolean = (process.env.FB_USE_ADC === "true") || false
  ...
  public ES_CLOUD_ID: string = process.env.ES_CLOUD_ID || null
  public ES_SECRET_RESOURCE_ID: string = process.env.ES_SECRET_RESOURCE_ID || null
